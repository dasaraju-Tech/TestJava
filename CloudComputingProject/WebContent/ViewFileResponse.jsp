        ...
        <div class="col-xl-10 d-flex align-items-center justify-content-between">
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li class="active" ><a href="ViewFileResponse.jsp"><h5>View File Response</h5></a></li>
              <li><a href="ViewTopKFilesUser.jsp"><h5>View Top K Files</h5></a></li>
...
<c:choose>  
    <c:when test="${u.isRequest() == true && u.isGenerate()== true}">  
       <a href="downloadFileServlet?id=${u.getId()}">Download</a>
