...
<body>
        ...
        <div class="col-xl-10 d-flex align-items-center justify-content-between">
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li  class="active" ><a href="SearchFileUser.jsp"><h5>Search File</h5></a></li>
 ...
 <section>
<h1>Search file in the Cloud</h1>
<br/>
<form action="SearchFiles" method="post" > 
<div class="container" > 
<table align="center" cellspacing="15">  
<tr><td><b>KeyWord:</b></td>
<td><input type="text" name="keyword" placeholder="Enter the key"/></td></tr>  
...
<td> 
      ...
      <a href="FileRequest?req=${f.getId()}">request</a> 
      </td>
