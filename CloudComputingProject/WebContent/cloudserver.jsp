        ...
        <div class="col-xl-10 d-flex align-items-center justify-content-between">
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li class="active" ><a href="cloudserver.jsp"><h5>Cloud Server</h5></a></li>
              <li><a href="dataowner.jsp"><h5>Data Owner</h5></a></li>
              <li><a href="datauser.jsp"><h5>Data User</h5></a></li>
              <li><a href="registration.jsp"><h5>Registraion</h5></a></li>
            </ul>
...
<tr>
<td> </td>
<td colspan="2"><input type="reset" value="Reset" />&nbsp;&nbsp;<input type="submit" value="Login"/></td></tr>  
</table>  
</form>  
