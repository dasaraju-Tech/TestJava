...
<body>
        ...
        <div class="col-xl-10 d-flex align-items-center justify-content-between">
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li class="active" ><a href="ViewFilesOwner.jsp"><h5>View Files</h5></a></li>
 ...
 <section>
  <h1><b>View Your File Details</b></h1>
  </section>
...
List<Fileowner> flist=MainDAO.readFiledata(x.getUserName());  
