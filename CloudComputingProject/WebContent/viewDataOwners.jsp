<%@page import="com.jts.DAO.MainDAO,com.jts.main.Registration,java.util.*"%>  
...
<body>
      ...
      <div class="row justify-content-center">
        <div class="col-xl-10 d-flex align-items-center justify-content-between">
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              <li><a href="CloudHomePage.jsp"><h5>Home Page</h5></a></li>
              <li class="active" ><a href="viewDataOwners.jsp"><h5>View Data Owners</h5></a></li>
  ...
  <section>
  <h1><b>All Data Owners</b></h1>
  </section>
  
  
  <%  
List<Registration> list=MainDAO.readDataOwners();  
...
<td><c:out value="${u.getContactNumber()}" /></td>
<td><c:out value="${u.getEmail()}" /></td>
<td><c:out value="${u.getAddress()}" /></td>
<td><c:out value="${u.getGender()}" /></td>
<td><c:out value="${u.getUserType()}" /></td>
<td>

<c:choose>  
    <c:when test="${u.isStatus() == false}">  
       <a href="ActivateServlet?id=${u.getId()}">activate</a>
