        ...
        <div class="col-xl-10 d-flex align-items-center justify-content-between">
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li class="active" ><a  href="UploadFileOwner.jsp"><h5>Upload File</h5></a></li>
              <li><a  href="ViewFilesOwner.jsp"><h5>View Files</h5></a></li>
              <li><a href="ViewFileRequestOwner.jsp"><h5>View File Request</h5></a></li>
...
<tr><td><b>Keyword:</b></td><td>  
<input type="text" name="keyword"/></td></tr>  

<tr><td><b>Document Type:</b></td><td>  
...
<tr><td><b>Choosefile:</b></td><td>  
<input type="file" name="file"/></td></tr>  


<tr>
<td> </td>
<td colspan="2"><input type="submit" value="Upload" />&nbsp;&nbsp;&nbsp;<input type="Reset" value="Reset"/></td></tr>  
</table>  
</form>  
