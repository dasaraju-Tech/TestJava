...
<body>
      ...
      <div class="row justify-content-center">
        <div class="col-xl-10 d-flex align-items-center justify-content-between">
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
               <li><a href="HomePageowner.jsp"><h5>Home Page</h5></a></li>
              <li><a href="UploadFileOwner.jsp"><h5>Upload File</h5></a></li>
              <li><a href="ViewFilesOwner.jsp"><h5>View Files</h5></a></li>
              <li class="active" ><a href="ViewFileRequestOwner.jsp"><h5>View File Request</h5></a></li>
              <li><a href="ViewTopKFilesOwner.jsp"><h5>View Top K Files</h5></a></li>
  ...
  <section>
  <h1><b>All Data Users</b></h1>
  </section>
  
  
  <%  
List<Fileowner> list=MainDAO.readRequestFiles();  
...
<td><c:out value="${u.getFileName()}" /></td>
<td><c:out value="${u.getFileOwner()}" /></td>
<td><c:out value="${u.getReqUser()}" /></td>
<td><c:out value="${u.getUploadtime()}" /></td>

<td>

<c:choose>  
    <c:when test="${u.isRequest() == true && u.isGenerate()== false}">  
       <a href="Generate?id=${u.getId()}">Generate</a>
