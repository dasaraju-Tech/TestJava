...
input , select {
	...
	<body>
				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li  class="active"><a href="UserLogin.jsp">User Login</a>
		...
		<h2>Registration form</h2>
								<form action="UserRegistrationControl" style="width: 90%;">
								...
								<input type="text" name="passport" placeholder="Enter your passport number" ><br>
								<label>Email :</label><br>
								<input type="email" name="email"  placeholder="Enter your passport Email"><br>
