				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li  class="active"><a href="CancelFlight.jsp">Cancel Flight</a></li>
						...
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-6">
								 ...
								 <div class="col-md-6">
									<div class="form-group">
										<input type="text" class="form-control" placeholder="Aadhar number" name="id">
									</div>
								</div> 
								<div class="col-md-12">
									<div class="form-group">
										<textarea class="form-control" cols="30" rows="7" placeholder="cancellation of tickets will be considered based on your reason and incase of criminal cases on you" name="message"></textarea>
									</div>
								</div>
